function $Showhtml(){
	...
	player += '<param name="Title" value="本站由<极速影视导航系统>建设!">';
	player += '<param name="AdURL" value='+Player.Buffer+'>';
	player += '<param name="EmbedURL" value="http://www.jisucms.com/?web9">';
	player += '<param name="URL" value="'+url+'">';
	player += '<param name="TextAds" value="极速影视导航系统ASP版|http://www.jisucms.com/@极速影视导航系统PHP版|http://www.jisucms.com">';
